...
ssh -o StrictHostKeyChecking=no cloud-user@openshift-node1.example.com sudo service flanneld restart
ssh -o StrictHostKeyChecking=no cloud-user@openshift-node1.example.com sudo service docker restart
ssh -o StrictHostKeyChecking=no cloud-user@openshift-node1.example.com sudo service origin-node restart

ssh -o StrictHostKeyChecking=no cloud-user@openshift-node2.example.com sudo service flanneld restart
ssh -o StrictHostKeyChecking=no cloud-user@openshift-node2.example.com sudo service docker restart
ssh -o StrictHostKeyChecking=no cloud-user@openshift-node2.example.com sudo service origin-node restart
# master and nodes
